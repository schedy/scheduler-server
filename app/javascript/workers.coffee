                                                ...
                                                m 'tbody.workers-table',
                                                        if workers? and workers.initialized
                                                                ...
                                                                for worker in workers_sorted
                                                                        terminal_url = 'http://'+window.location.hostname+'/ssh/host/'+worker.ip
                                                                                                ...
                                                                                                m '.row.resource-column-wrapper',
                                                                                                        if worker.resources?
                                                                                                                for resource in worker.resources
                                                                                                                        ...
                                                                                                                        else if resource.task_id == null then hsl_degree = 200; sat_degree=40; light_degree=50; resource_state="Available";
                                                                                                                        ...
                                                                                                                        m '.container-sm.resource-box',{'data-resource-state': resource_state, 'data-task-id': task_id, 'data-execution-id': resource.execution_id},
                                                                                                                                m '.row.resource-header',
                                                                                                                                        ...
                                                                                                                                        m 'a.resource-name[href=?show=resourcecontrol&worker_id='+worker.id+'&resource_id='+resource.id+']', {"title":"Resource Control"}, resource.type
                                                                                                                                m '.row.resource-body',
